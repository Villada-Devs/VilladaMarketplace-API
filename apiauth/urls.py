...
from .views import EventsDetailView, EventsViewSet, ResendEmailVerificationView, poolsListView, myPoolsView
...
router.register('mypools', myPoolsView, basename='PoolsFromEachUser')
