...
from .views import EventsDetailView, EventsViewSet, ResendEmailVerificationView, poolsListView, GoogleLogin
...
urlpatterns = [
    ...
    re_path(r'^dj-rest-auth/password/reset/confirm/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,40})/$', PasswordResetConfirmView.as_view(), name='password_reset_confirm'),
